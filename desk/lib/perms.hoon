::  perms: permission categorization and rendering for landscape
::
...
+$  deal
  ...
  ==
+$  tag
  ?(%local %remote %read %write %kernel %core %landscape %app %http)
::
...
++  scry-live
  ...
  :: %+  roll  (get-apps-have:hood ^our des ^now)
  |=  [[dud=dude ?] =_out]
  (~(put by out) dud des)
::
++  scry-apps
...
++  perm-tree
  ...
  ++  perm-tags
    ...
    ++  with-dude
      ...
      ?:  (~(has in land-dudes) dude)  [%landscape tags]
      [%app tags]
    ::
    ++  with-desk
      |=  [=desk tags=(list tag)]
  ...
  ++  perm-kind  ::  "this app wants to ..." but higher-level
    ...
    ::
      ...
      [%clay %perms *]  'manage your apps'
      [%clay %plead *]  'manage your apps'
  ...
  ++  perm-cord  ::  "this app wants to ..."
    ...
    ::
      ...
      [%clay %write *]  'TODO  write files on [desk] at & under [path]'
